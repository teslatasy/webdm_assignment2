...
class CorpusProcess(object):
    ...
    def __init__(self):
        """初始化"""
        self.train_corpus_path =  os.path.join(dir,"1980_01rmrb.txt")
        self.process_corpus_path =  os.path.join(dir,"result-rmrb.txt")
...
class CRF_NER(object):
    ...
    def __init__(self):
        ...
        self.model_path = os.path.join(dir,"model.pkl")
...
print(ner.predict('新华社北京十二月三十一日电习近平近日访问了美国。'))
